...
local function stop_all_farming()
    ...
    explorer.disable()  -- Adicionar esta linha
    Movement.set_explorer_control(false)  -- Adicionar esta linha
...
local function handle_non_helltide()
    if was_in_helltide then
        ...
        ChestsInteractor.reset_for_new_helltide()
...
maidenmain.init()
console.print(">>Helltide Chests Farmer Eletroluz V2.2 with Maiden integration and auto rotation<<")